                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text('First Air: ${tv.firstAirDate}',
                              style: TextStyle(color: Colors.white70)),
                          SizedBox(width: 16),
                          Icon(Icons.calendar_today_outlined,
                              size: 18, color: Colors.white54),
                          SizedBox(width: 4),
                          Text('Last Air: ${tv.lastAirDate}',
                              style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                      SizedBox(height: 8),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text('Languages: ${tv.languages.join(', ')}',
                              style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                      SizedBox(height: 8),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text('Country: ${tv.originCountry.join(', ')}',
                              style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                      SizedBox(height: 8),
                      ...
                      Row(
                        children: [
                          Icon(Icons.confirmation_number,
                              size: 18, color: Colors.white54),
                          SizedBox(width: 4),
                          Text('Seasons: ${tv.numberOfSeasons}',
                              style: TextStyle(color: Colors.white70)),
                          SizedBox(width: 16),
                          Icon(Icons.confirmation_number_outlined,
                              size: 18, color: Colors.white54),
                          SizedBox(width: 4),
                          Text('Episodes: ${tv.numberOfEpisodes}',
                              style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                      SizedBox(height: 8),
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('${tv.voteAverage} (${tv.voteCount} votes)',
                              style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                      SizedBox(height: 16),
                      FilledButton(
                        onPressed: () async {
                          ...
                          final message = Provider.of<TvDetailNotifier>(context,
                                  listen: false)
                              .watchlistMessage;
                          if (message ==
